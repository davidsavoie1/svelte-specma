...
- `fields`: Collection. A deeply nested collection description of which fields to expect, that will ensure that those fields are included in the collection and others are not, for proper change detection.
